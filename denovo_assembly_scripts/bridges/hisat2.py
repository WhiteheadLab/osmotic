...
hisat2 -p 14 \\
--dta -x \\
/pylon5/bi5fpmp/ljcohen/Fhet_reference_genome/ncbi/Fhet_ncbi_hisat2/Fhet_tran \\
-1 {} \\
-2 {} \\
-S {}{}.sam
samtools sort -@ 8 -o {}{}.bam {}{}.sam
rm {}{}.sam
""".format(read1,read2,stardir,sample,stardir,sample,stardir,sample,stardir,sample)
        print(star_string)
...
stardir="/pylon5/bi5fpmp/ljcohen/kfish_hisat2/"
