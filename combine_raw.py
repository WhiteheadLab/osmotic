...
def get_readnumbers_dictionary(filename_dictionary):
	read_num_stats="read_num_stats.txt"
	#with open(read_num_stats),"w") as statsfile:
	for sample in filename_dictionary.keys():
		sample_name="_".join(sample)
		#statsfile.write(sample_name+"\t")
		print sample_name
		for filename in filename_dictionary[sample]:
...
get_readnumbers_dictionary(filename_dictionary)
