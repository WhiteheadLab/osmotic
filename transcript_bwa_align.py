...
def get_assemblies(assemblydir):
	...
	for genus_species in genus_species_dirs:
		...
		module_load_list=["module load bwa/0.7.9a","module load samtools/1.2"]
...
def bwa_index():
	bwa_index_command="""
bwa index -p fund_ref /home/ljcohen/reference/killifish20130322asm.fa
""".format()
	return bwa_index_command 

def bwa_mem(assemblyfile,bam_out,flagstat_out):
	bwa_command="""
bwa mem /home/ljcohen/reference/fund_ref {} | samtools view -b - > {} 
samtools flagstat {} > {}
